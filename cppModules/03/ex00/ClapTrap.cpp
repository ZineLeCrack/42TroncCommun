...
/*   Updated: 2025/01/28 19:03:15 by romain           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << "ClapTrap " << this->_name << " repairs itself of " << amount
		<< " hits point!" << std::endl;
		this->_hitPoints += amount;
		this->_energyPoints--;
	}
	else if (this->_hitPoints == 0)
		std::cout << "ClapTrap " << this->_name << " can't repairs itself, it's dead!"
		<< std::endl;
	else
